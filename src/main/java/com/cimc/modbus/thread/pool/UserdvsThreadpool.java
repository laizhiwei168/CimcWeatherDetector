...
public class UserdvsThreadpool {
//	
    private static UserdvsThreadpool threadPool;
  ...
  //加锁
    ...
    public static UserdvsThreadpool init(){
    	if (threadPool == null){
            instanceLock.lock();
            if(threadPool == null) {
            	threadPool=new UserdvsThreadpool();
            }
            instanceLock.unlock();
        }    	
        return threadPool;
