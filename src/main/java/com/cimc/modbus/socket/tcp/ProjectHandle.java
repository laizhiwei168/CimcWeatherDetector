package com.cimc.modbus.socket.tcp;
...
import com.cimc.modbus.protocol.service.ProtocolServiceImpl;
...
public class ProjectHandle implements IDataHandler, IConnectHandler,IDisconnectHandler {
	...
	public boolean onDisconnect(INonBlockingConnection connection)
        ...
        System.out.println("总共在线人数"+deviceUserManager.getOnlineCount());
        return true; 
	}
